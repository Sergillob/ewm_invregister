		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#viscofanewminvregister-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"viscofanewminvregister-display": {
								"semanticObject": "viscofanewminvregister",
								"action": "display",
								"description": "Inventory Register",
								"title": "Inventory Register",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=viscofan.ewminvregister",
									"url": sap.ui.require.toUrl("viscofan/ewminvregister")
								}
							}
						}
					}
